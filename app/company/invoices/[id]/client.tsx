...
import { ArrowLeft, Receipt, Building2, Briefcase, FileText, DownloadCloud, FilePlus } from "lucide-react";
import { useState, useTransition } from "react";
import { toast } from "sonner";
import { generateInvoicePDFAction } from "@/actions/invoice.action";
...
export default function CompanyInvoiceDetailClient({ invoice }: { invoice: InvoiceDetail }) {
            ...
            <main className="px-4 py-5 max-w-xl mx-auto space-y-4">
                ...
                <div className="bg-card border border-border/60 rounded-2xl p-5 space-y-4">
                    <div className="flex items-center justify-between">
                        ...
                        <span className={`px-3 py-1 rounded-full border text-xs font-bold tracking-wide ${getStatusStyle(invoice.status)}`}>
                            {invoice.status}
                        </span>
                    </div>
                ...
                <div className="bg-card border border-border/60 rounded-2xl p-4 space-y-2">
                    ...
                    <p className="text-sm font-bold">{invoice.jobTitle}</p>
